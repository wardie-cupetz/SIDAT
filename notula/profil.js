...
(() => {
    ...
    const ICON_EYE_OFF = `
        ...
        >
            ...
            <path
                d="M10.6 6.2A9.9 9.9 0 0 1 12 6c6 0 9.5 6 9.5 6a16.6 16.6 0 0 1-3.1 3.8"
            />

            <path
                d="M6.2 6.8C3.8 8.2 2.5 12 2.5 12s3.5 6 9.5 6c1.5 0 2.8-.3 4-.8"
            />
    ...
    async function loadProfile() {
        ...
        try {
            ...
            if (
                ...
                showError(
                    "Akses ditolak. Halaman ini khusus NOTULA."
                );
            ...
            console.log(
                "[SIDAT] Profil NOTULA berhasil dimuat."
            );
    ...
    async function loadResidentData() {
        ...
        /*
           Akun NOTULA umumnya tidak memiliki
           resident_id.

           Tetapi apabila suatu saat akun NOTULA
           dihubungkan ke residents, nama warga
    ...
    function showToast(
        ...
        /*
           CSS profil-rt menggunakan .toast.show.
           Jadi kita tambahkan class show agar
           animasi toast benar-benar tampil.
        */
